...
Verschmolzen aus Upstream-Rework (harden ontology JSON generation:
Kompat-Layer, robustes JSON-Parsing, finish_reason-Checks) und unseren
Fork-Erweiterungen (transienter Retry mit Backoff, Admin-Modell-Override).
"""
...
class LLMClient:
    ...
    def _create_completion(
        ...
        *,
        ...
        """Roh-Request über den Kompat-Layer — mit transientem Retry.

        Timeout/429/5xx werden bis zu 3x mit Backoff wiederholt; Auth-,
        Guthaben- und Parameter-Fehler (400/401/402/422 …) sofort
        durchgereicht (damit z. B. der response_format-Fallback in
        chat_json greifen kann)."""
